...
class DCRNN(BaseModel):
    ...
    '''
    def __init__(self, node_num,device, adj_mx, n_filters, max_diffusion_step, filter_type, \
    ...
    def forward(self, source, supports,target, iter=None):  # (b, t, n, f)
